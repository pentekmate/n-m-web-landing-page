...
export default function Button({type,text,navigate,icon,navigateTo}:ButtonProps){
    ...
    const styles = {
        ...
        cardSecondary:defaultStyle+ ` text-black  font-medium hover:shadow-md  px-2 py-2 xl:w-[195px] xl:h-[36px] bg-white text-cyellow text-sm`,
        cardPrimary:defaultStyle + ` text-white primary-button font-medium hover:shadow-md  px-2 py-2 xl:w-[195px] xl:h-[36px] bg-gradient-to-br from-customStart to-customEnd text-cyellow text-sm`,
