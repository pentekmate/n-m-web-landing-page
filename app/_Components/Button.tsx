...
export default function Button({type,text,onClick,icon}:ButtonProps){
    ...
    const defaultStyle = `${inter.className} rounded-[73px] relative overflow-hidden button  uppercase flex items-center justify-center  cursor-pointer `
    const styles = {
        primary:defaultStyle + ` bg-gradient-to-br primary-button from-customStart to-customEnd text-white w-[250px] h-[68px]`,
        secondary:defaultStyle + ` ${inter.className} text-black  text-cyellow font-medium border-[1px] border-cyellow  w-[250px] h-[68px]`,
