    ...
    <>
      ...
      <div className="w-full flex flex-col md:flex-row h-[450px] border">
        <div className="w-full md:w-1/2 flex items-center justify-center p-4">
          <div>
            {/* probalj majd meg igazodni a designhoz, a fontok nem stimmelnek, sem stilus sem meretben */}
            <h1 className={`text-[61px] font-semibold m-3 ${poppins.className}`}>Egyedi webfejlesztés</h1>
